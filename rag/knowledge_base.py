...
DOCUMENTS: list[dict] = [
    ...
    # ──────────────────────────────────────────────────────────────────────────
    # DATA ANALYST KEYWORDS И ПАТТЕРНЫ
    # ──────────────────────────────────────────────────────────────────────────

    {
        "id": "dir_da_keywords_core",
        "text": "Data Analyst ATS-ключевые слова (core): "
                "SQL, Python, pandas, numpy, Excel, Google Sheets, "
                "Tableau, Power BI, Superset, Metabase, Looker, "
                "A/B тестирование, когортный анализ, воронки, retention, churn, "
                "ETL, data pipeline, дашборды, отчётность.",
        "grade": "any", "direction": "Data Analyst", "doc_type": "keywords",
    },
    {
        "id": "dir_da_keywords_advanced",
        "text": "Data Analyst продвинутые ATS-ключевые слова: "
                "статистика, гипотезы, p-value, доверительный интервал, "
                "регрессия, кластеризация, сегментация, RFM-анализ, "
                "BigQuery, Redshift, Snowflake, ClickHouse, Spark, Airflow, "
                "продуктовые метрики, DAU, MAU, ARPU, LTV, CAC.",
        "grade": "any", "direction": "Data Analyst", "doc_type": "keywords",
    },
    {
        "id": "dir_da_achievements",
        "text": "Data Analyst достижения-паттерны: "
                "'Построил дашборд для X метрик, сократив время подготовки еженедельного отчёта с 5 часов до 20 минут', "
                "'Провёл A/B тест новой механики, подтвердил рост конверсии на 12%', "
                "'Выявил сегмент пользователей с LTV в 3 раза выше среднего, что легло в основу маркетинговой кампании', "
                "'Оптимизировал SQL-запросы в хранилище, снизив время выполнения с 8 минут до 40 секунд'.",
        "grade": "any", "direction": "Data Analyst", "doc_type": "achievements",
    },
    {
        "id": "dir_da_junior_advice",
        "text": "Junior Data Analyst специфика: "
                "акцент на владении SQL (JOIN, оконные функции, агрегации) и Python (pandas). "
                "Pet-проект: взять публичный датасет (Kaggle), построить дашборд в Tableau Public или Superset. "
                "Курсы: Яндекс.Практикум, karpov.courses, Stepik 'Анализ данных'. "
                "Указывать конкретные источники данных с которыми работал.",
        "grade": "Junior", "direction": "Data Analyst", "doc_type": "advice",
    },
    {
        "id": "dir_da_senior_advice",
        "text": "Senior/Lead Data Analyst специфика: "
                "самостоятельное проектирование аналитической инфраструктуры. "
                "Описывать: построение Data Warehouse с нуля, внедрение метрик-фреймворков (OKR, HEART), "
                "работу с продуктовыми командами как аналитический партнёр, "
                "автоматизацию регулярной отчётности, обучение других аналитиков.",
        "grade": "Senior", "direction": "Data Analyst", "doc_type": "advice",
    },

    # ──────────────────────────────────────────────────────────────────────────
    # БИЗНЕС-АНАЛИТИК KEYWORDS И ПАТТЕРНЫ
    # ──────────────────────────────────────────────────────────────────────────

    {
        "id": "dir_ba_keywords_core",
        "text": "Бизнес-аналитик ATS-ключевые слова (core): "
                "требования, бизнес-процессы, BPMN, UML, user story, use case, "
                "ТЗ, техническое задание, функциональные требования, NFR, "
                "Confluence, Jira, draw.io, Miro, Notion, "
                "стейкхолдеры, интервью с заказчиком, согласование требований.",
        "grade": "any", "direction": "Бизнес-аналитик", "doc_type": "keywords",
    },
    {
        "id": "dir_ba_keywords_advanced",
        "text": "Бизнес-аналитик продвинутые ATS-ключевые слова: "
                "AS-IS / TO-BE, gap-анализ, декомпозиция, приоритизация, MoSCoW, "
                "управление изменениями, трассировка требований, "
                "SQL (базовый уровень), API (понимание), Swagger/OpenAPI (чтение), "
                "Agile, Scrum, Kanban, backlog, спринт, MVP, roadmap.",
        "grade": "any", "direction": "Бизнес-аналитик", "doc_type": "keywords",
    },
    {
        "id": "dir_ba_achievements",
        "text": "Бизнес-аналитик достижения-паттерны: "
                "'Собрал и задокументировал требования для N проектов, ни один не вышел за рамки бюджета', "
                "'Описал AS-IS процесс обработки заявок, выявил 5 узких мест, TO-BE сократил время обработки на 35%', "
                "'Провёл N интервью со стейкхолдерами, согласовал требования между 3 подразделениями', "
                "'Подготовил пакет документации (ТЗ + user stories + acceptance criteria) для команды из 8 разработчиков'.",
        "grade": "any", "direction": "Бизнес-аналитик", "doc_type": "achievements",
    },
    {
        "id": "dir_ba_patterns",
        "text": "Бизнес-аналитик паттерны формулировок: "
                "'Формализовал требования бизнеса в user stories с acceptance criteria', "
                "'Построил BPMN-диаграмму процесса X, согласовал с командой разработки и бизнесом', "
                "'Выступал единым окном между бизнесом и IT на протяжении N месяцев', "
                "'Вёл и приоритизировал product backlog совместно с product owner'.",
        "grade": "any", "direction": "Бизнес-аналитик", "doc_type": "patterns",
    },

    # ──────────────────────────────────────────────────────────────────────────
    # СИСТЕМНЫЙ АНАЛИТИК KEYWORDS И ПАТТЕРНЫ
    # ──────────────────────────────────────────────────────────────────────────

    {
        "id": "dir_sa_keywords_core",
        "text": "Системный аналитик ATS-ключевые слова (core): "
                "REST API, SOAP, gRPC, HTTP, JSON, XML, "
                "OpenAPI, Swagger, Postman, интеграции, "
                "UML, диаграмма последовательностей, диаграмма компонентов, "
                "BPMN, техническая спецификация, архитектура систем, "
                "SQL, базы данных, схема данных, ER-диаграмма.",
        "grade": "any", "direction": "Системный аналитик", "doc_type": "keywords",
    },
    {
        "id": "dir_sa_keywords_advanced",
        "text": "Системный аналитик продвинутые ATS-ключевые слова: "
                "микросервисы, event-driven, message broker, Kafka, RabbitMQ, "
                "асинхронное взаимодействие, очереди, webhook, "
                "авторизация, OAuth 2.0, JWT, SSO, LDAP, "
                "Confluence, Jira, draw.io, PlantUML, "
                "NFR (нефункциональные требования), SLA, масштабируемость, отказоустойчивость.",
        "grade": "any", "direction": "Системный аналитик", "doc_type": "keywords",
    },
    {
        "id": "dir_sa_achievements",
        "text": "Системный аналитик достижения-паттерны: "
                "'Спроектировал интеграцию между X и Y через REST API, описал контракт в OpenAPI 3.0', "
                "'Разработал техническую спецификацию для N интеграций, снизив количество доработок на 40%', "
                "'Задокументировал N API-методов с примерами запросов и ответов в Swagger', "
                "'Декомпозировал монолитную систему на X сервисов, описал все точки интеграции'.",
        "grade": "any", "direction": "Системный аналитик", "doc_type": "achievements",
    },
    {
        "id": "dir_sa_patterns",
        "text": "Системный аналитик паттерны формулировок: "
                "'Разработал архитектурное решение интеграции систем X и Y, согласовал с командами разработки', "
                "'Описал диаграммы последовательностей для N бизнес-сценариев в PlantUML/draw.io', "
                "'Провёл анализ текущей архитектуры, выявил N точек отказа, предложил решения', "
                "'Являлся техническим посредником между бизнес-аналитиком и командой разработки'.",
        "grade": "any", "direction": "Системный аналитик", "doc_type": "patterns",
    },
    {
        "id": "combo_middle_sa",
        "text": "Middle Системный аналитик специфика: "
                "самостоятельное проектирование интеграций от анализа до передачи разработчикам. "
                "Обязательно: опыт работы с Postman (тестирование API), "
                "понимание асинхронных интеграций (Kafka/очереди), "
                "умение читать и писать SQL (для анализа данных в системе). "
                "Демонстрировать знание жизненного цикла разработки (SDLC).",
        "grade": "Middle", "direction": "Системный аналитик", "doc_type": "advice",
    },
]
